;        
;                               ._
;                      __  ____ |//    __.                    _______ _,       _ _,
;              ___  _\(  \/   /_    ___ /                ____ \    _/(/     ____ /_
;           _\(   \ /   __     / _\(   /_       ______. /   /__\_  \_  ___ /    //_)/
;         _/  _    /   /_/   _/__\       \ _____\_    |/  _/_\  __ _///   /    /______
;        _)   /  _/   //__       /  /\    \X     /  __|   \__ \    \/  _ _\___       /
;        \       \  _ \ _/      //  /\    / \   //  \ :_    /    /     \   _ /      /
;        d\_      \ /  \\      //  /_ X _    \_ /    \  /  `   _X          \/     _/
;        iP/___ ___X    /\     /____//  \_    //       //___ __) \_      \______ _)dS!
;        % %%%%Y%%%/___/%%\___/%%%%%%\_ _____/_\       /%%%%Y%%%%%(__ _____/%%%%Y%%%%
;              .                       Y        \___ _/     .        Y          .
;                                      .            Y                .
;                                                   .
;        credits:
;        code Lynx/Oranges
;        template dual buffer VSCode by Gigabate/Desire
;----------------------------------------------------------
